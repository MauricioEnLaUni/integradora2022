...
function exhibit(where,row,id){
  ...
  switch(row['it_br']){
    ...
    case "ECCO":
      ...
      break;
    case "Hush Puppies":
      brand = '<img src="img/brands/hush.webp" style="background-color: white;"/>';
      break;
    case "Nike":
