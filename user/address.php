...
<?php
  ...
  <div class="col-12 col-sm-6 col-md-4 justify-content-center align-items-center">
    <div class="row userNav addCards d-flex">
      <p class="h2 mt-3 col-9"><strong>Dirección</strong>
      <?php
      ...
      <form action="user/address/addResult.php" method="post">
        ...
        <a style="color: var(--blueU);" class="btn btn-link col-3" href="user/address/addDel.php?i=<?php echo $row['ad_id']; ?>">Descartar</a>
      </form>
